...
function kb_PRINSEQ(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.execReadLibraryPRINSEQ = function (input_params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_PRINSEQ.execReadLibraryPRINSEQ",
            [input_params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_PRINSEQ.status",
